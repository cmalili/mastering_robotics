...
def pick_and_place_with_suction_cup(x1,y1,z1,r1,x2,y2,z2,r2, offset=80):
    start = time.time()
...
x1,y1,z1,r1 = 281.16,-83.78,-42.48,-16.59
x2,y2,z2,r2 = 283.01,-28.23,-42.45,-5.70
x3,y3,z3,r3 = 342.35,-25.73,-44.04,-4.30
x4,y4,z4,r4 = 339.78,-87.17,-45.48,-14.39

x5,y5,z5,r5 = 279.2,14.12,-41.79,2.9
x6,y6,z6,r6 = 283.91,73.03,-42.25,14.43
x7,y7,z7,r7 = 341.70,73.83,-42.71,12.20
x8,y8,z8,r8 = 341.92,12.85,-41.11,2.15
...
for p1, p2 in zip(p1_corners, p2_corners):
    t = pick_and_place_with_suction_cup(p1[0],p1[1],p1[2],p1[3],
                                p2[0],p2[1],p2[2],p2[3])
